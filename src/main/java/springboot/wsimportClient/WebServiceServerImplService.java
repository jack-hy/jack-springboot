 ...
 * 
 */
@WebServiceClient(name = "WebServiceServerImplService", targetNamespace = "http://webservice.springboot/", wsdlLocation = "http://localhost:18080/springboot/springboot-ws/api?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICESERVERIMPLSERVICE_QNAME = new QName("http://webservice.springboot/", "WebServiceServerImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:18080/springboot/springboot-ws/api?wsdl");
    ...
    public WebService getWebServicePort() {
        return super.getPort(new QName("http://webservice.springboot/", "WebServicePort"), WebService.class);
    }
    ...
    public WebService getWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.springboot/", "WebServicePort"), WebService.class, features);
    }
