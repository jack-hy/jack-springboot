 ...
 * generated in the com.soft.test.wsimportClient package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetInfoResponse_QNAME = new QName("http://webservice.springboot/", "getInfoResponse");
    private final static QName _GetInfo_QNAME = new QName("http://webservice.springboot/", "getInfo");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.soft.test.wsimportClient
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.springboot/", name = "getInfoResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.springboot/", name = "getInfo")
